      ...
      <div className="flex flex-wrap lg:flex-nowrap lg:mt-10">
        <div>
          ...
          <p className="mt-5 text-slate-700 dark:text-slate-400">
            ...
            . Technology is my passion, and I am always looking for
            opportunities to learn new things. Here, you will find examples of
            my work in web development, which I have been studying using{" "}
            <b className="font-bold text-black dark:text-white underline">
              PHP
            </b>{" "}
            as my programming language. In addition to my technical skills, I
            also value teamwork and enjoy collaborating on projects with others.
            I hope you enjoy looking through my portfolio and learning more
          ...
          <div className="mt-10">
            ...
            <ol className="items-center sm:flex mt-5">
              <Timeline1
                ...
                date={"2021 - 2024"}
                desc={"Making few projects with my classmates"}
              />
              <Timeline1
                title={"SMP Negeri 15 Semarang"}
                date={"2018 - 2021"}
                desc={"Be an active member of the class"}
              />
            </ol>
          </div>
          ...
          <div className="mt-10">
            ...
            <ol className="items-center sm:flex mt-5">
              <Timeline1
                title={
                  "Back-end Web Developer, PT Insan Membangun Bangsa (Azuralabs)"
                }
                desc={
              ...
              <Timeline1
                ...
                desc={"Work with the team on making API using Laravel"}
          ...
          <div className="mt-10">
            ...
            <ol className="items-center sm:flex mt-5">
              <Timeline3
                ...
                date={"HyperText Markup Language"}
              />
              ...
              <Timeline3
                ...
                date={"PHP: Hypertext Preprocessor"}
              />
              ...
              <Timeline3
                ...
                date={"Front-end JavaScript library "}
              />
            </ol>
          </div>
        </div>
